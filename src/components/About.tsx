    ...
    <section id="about" className="py-20 lg:py-32 bg-secondary/50">
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          {/* ROW 1: Section Header (Full Width) */}
          <div className="w-full mb-10 text-left">
            <Badge>About Z AXIS</Badge>
            <h2 className="text-3xl lg:text-4xl font-bold tracking-tighter mt-2">
              Wellness To All / सर्वे सन्तु निरामया:
            </h2>
          </div>

          {/* ROW 2: Vision & Mission (PRIMARY FOCUS ZONE) */}
          <div className="grid gap-6 md:grid-cols-2 mb-10">
            <Card className="h-full border-border/60 bg-background/70 shadow-sm ring-1 ring-primary/10">
            ...
            <Card className="h-full border-border/60 bg-background/70 shadow-sm ring-1 ring-primary/10">
              <CardHeader className="pb-2 pt-6 px-6">
                <CardTitle className="text-2xl lg:text-3xl">Mission</CardTitle>
              </CardHeader>
              <CardContent className="px-6 pb-6 pt-0">
                <p className="text-base lg:text-lg text-muted-foreground leading-relaxed">
          ...
          {/* ROW 3: Company Description (Full Width Narrative) */}
          <div className="w-full mb-10">
            <p className="text-lg text-muted-foreground leading-relaxed max-w-5xl">
              ...
              Z Axis introduces a bold new Z-Dimensional approach to advanced injectable fill–finish systems, redefining 
              performance, reliability, and compliance for the modern pharmaceutical landscape.
            </p>
          </div>

          {/* ROW 4: Core Pillars (Supporting Information) */}
          ...
          {/* ROW 5: Founder (Standalone, Secondary Emphasis) */}
          <div className="w-full">
            <Card className="border-border/60 bg-background/50 shadow-sm max-w-4xl">
              <CardHeader className="pb-2">
